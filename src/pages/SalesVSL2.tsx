    ...
    <div className="bg-[#0a0a0a] min-h-screen text-slate-100 flex flex-col font-['Manrope'] antialiased overflow-x-hidden">
      ...
      <main className="flex-1 w-full max-w-md mx-auto px-4 pb-12 pt-6 flex flex-col items-center">
        ...
        <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-indigo-500/10 border border-indigo-500/20 mb-4">
          <span className="material-symbols-outlined text-indigo-500 text-sm" style={{ fontSize: '16px' }}>location_on</span>
        ...
        <h1 className="text-white text-3xl md:text-4xl font-extrabold leading-[1.15] text-center tracking-tight mb-2">
          Pare de Depender da <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 to-violet-600">Sorte</span> Para Vender...
        </h1>
        ...
        <div className="w-full relative group mb-8">
          <div className="absolute -inset-1 bg-gradient-to-b from-indigo-500/30 to-violet-600/30 rounded-2xl blur-lg opacity-75 group-hover:opacity-100 transition duration-1000 group-hover:duration-200"></div>
          <div className="relative w-full aspect-video rounded-xl bg-slate-900 overflow-hidden shadow-2xl ring-1 ring-white/10" style={{ backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuCKuzvgGm8uIZV4-nLbPTqN86m-1nMWj_kBWjXjiA2DjL2zV9PHLcFPJpr4V_ILquuaWgErd9AR9rSLvwwgQL1dIVK4sDjhGGBeMXnta4oa9i1Qm-r52r_mCHk4ZD8tIAKgPErUCQyDxchr3_m2Hje2SVwpF9ysKmliQG8tlUTz_mQymBhvUdNdHccuR1-pQBrB6Dy_LTz6Vi44fSp54ZfmLVCds65WxZVz_mX_k6s7sc-D7xfgwWmBep7kABZrXLh58eJ2ZfBkqmZP')", backgroundSize: 'cover', backgroundPosition: 'center' }}>
            ...
            <div className="absolute inset-0 flex items-center justify-center bg-black/40 backdrop-blur-[2px]">
              <button className="relative flex items-center justify-center w-16 h-16 rounded-full bg-indigo-600 text-white hover:scale-110 transition-transform duration-200 shadow-[0_0_40px_-10px_rgba(79,70,229,0.6)]">
          ...
          <div className="flex items-center justify-center gap-2 mt-3 text-xs text-slate-400">
            <span className="material-symbols-outlined text-indigo-500" style={{ fontSize: '16px' }}>verified</span>
        ...
        <div className="w-full py-8">
          <h2 className="text-white tracking-tight text-3xl font-extrabold leading-tight text-center mb-2">
            A Diferença é <span className="text-indigo-400">Clara</span>
          </h2>
          ...
          <div className="rounded-2xl border border-gray-700 bg-slate-900 overflow-hidden shadow-sm">
            <div className="grid grid-cols-2 bg-white/5 border-b border-gray-700">
              ...
              <div className="p-4 text-center bg-indigo-500/10">
                <span className="material-symbols-outlined text-indigo-500 mb-1 text-3xl">check_circle</span>
                <p className="text-xs font-bold text-indigo-400 uppercase tracking-wider">Com o Sistema</p>
              </div>
            </div>
            {[
              ...
              <div key={i} className="grid grid-cols-2 border-b border-gray-800 last:border-0">
                ...
                <div className="p-4 flex flex-col justify-center bg-indigo-500/5">
        ...
        <div className="w-full bg-white/5 py-10 rounded-3xl border border-gray-700 mt-8">
          <h2 className="text-white tracking-tight text-2xl font-bold leading-tight px-4 text-center pb-8">
            Os 3 Pilares do <span className="text-indigo-400">Sucesso</span>
          </h2>
          <div className="flex flex-col gap-6 px-4">
            {[
              ...
              <div key={i} className="group flex gap-4 p-5 rounded-xl bg-slate-900 border border-gray-700 shadow-sm hover:border-indigo-500/50 transition-all duration-300">
                <div className="flex-shrink-0">
                  <div className={`flex items-center justify-center w-12 h-12 rounded-full ${pillar.color === 'blue' ? 'bg-blue-900/30 text-blue-400' : pillar.color === 'purple' ? 'bg-purple-900/30 text-purple-400' : 'bg-indigo-500/10 text-indigo-400'}`}>
        ...
        <div className="w-full pt-16 pb-8">
          <span className="text-indigo-400 font-bold tracking-wider text-xs uppercase block text-center mb-2">O Caminho Completo</span>
          <h2 className="text-3xl font-extrabold leading-tight text-white text-center mb-2">
            O que você vai <br/><span className="text-indigo-400">aprender hoje</span>
          </h2>
                ...
                <div className="p-5 flex gap-4">
                  <div className="flex-1 flex flex-col justify-center">
                    <div className="inline-flex items-center gap-1.5 mb-2">
                      <span className="bg-indigo-500/10 text-indigo-400 text-[10px] font-bold px-2 py-0.5 rounded uppercase tracking-wide">Resultado: {mod.res}</span>
                    </div>
        ...
        <div className="w-full bg-gradient-to-b from-slate-900 to-slate-800 dark:from-slate-800 dark:to-black rounded-3xl p-6 text-white relative overflow-hidden shadow-xl mt-8">
          <div className="absolute top-0 right-0 w-64 h-64 bg-indigo-500/20 blur-[80px] rounded-full pointer-events-none -mr-16 -mt-16"></div>
          <div className="relative z-10">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-2xl font-bold">Pack de Bônus</h2>
              <div className="bg-indigo-600 text-white text-xs font-bold px-3 py-1 rounded-full animate-pulse">
                OFERTA ESPECIAL
              </div>
            </div>
            <div className="space-y-4">
              {[
                ...
                { title: "Bônus 3: Comunidade VIP", desc: "Acesso ao nosso grupo de networking.", price: "R$ 97,00", icon: "groups" },
                ...
                <div key={i} className="flex items-start gap-4 p-3 rounded-lg bg-white/5 border border-white/10 backdrop-blur-sm">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-indigo-400 mt-1 line-through opacity-70">{bonus.price}</p>
                  </div>
                </div>
              ))}
            </div>
            <div className="mt-8 pt-6 border-t border-white/10 text-center">
              ...
              <div className="flex items-center justify-center gap-3">
                <span className="text-2xl font-bold text-slate-400 line-through decoration-indigo-500/50 decoration-2">R$ 307,00</span>
                <span className="bg-indigo-600 text-white text-lg font-black px-4 py-1 rounded-lg transform rotate-[-2deg] shadow-[0_0_15px_rgba(79,70,229,0.4)]">
                  GRÁTIS
                </span>
              </div>
            </div>
        ...
        <div className="w-full pt-20 pb-8">
          <div className="inline-flex items-center justify-center px-3 py-1 rounded-full bg-indigo-500/10 text-indigo-400 text-xs font-bold uppercase tracking-wider mb-3">
            Histórias Reais
          </div>
          <h2 className="text-white text-3xl font-extrabold leading-tight tracking-tight mb-3">
            Quem ativou,<br/><span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 to-violet-600">colheu resultado</span>
          </h2>
            ...
            <div className="bg-slate-800 rounded-2xl shadow-sm border border-slate-700 overflow-hidden">
              ...
              <div className="p-4 space-y-4">
                ...
                <div className="bg-[#0b141a] p-3 rounded-lg border border-slate-700 relative">
                  <div className="absolute top-0 left-0 w-full h-1 bg-indigo-600/30 rounded-t-lg"></div>
                  <div className="flex flex-col gap-2">
                    ...
                    <div className="bg-indigo-900/40 self-end rounded-lg rounded-tr-none p-2 max-w-[85%] shadow-sm">
                      <p className="text-[11px] text-slate-100 leading-snug">
                        Sensacional! É só o começo. Mantém a constância nos anúncios.
                      </p>
                      <div className="text-[9px] text-indigo-100/60 text-right mt-1 flex items-center justify-end gap-0.5">
            ...
            <div className="bg-slate-800 rounded-2xl shadow-sm border border-slate-700 overflow-hidden">
              ...
              <div className="p-4 space-y-4">
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className="bg-indigo-900/20 p-2 rounded-lg text-center border border-indigo-900/30">
                    <p className="text-xs text-indigo-400 uppercase font-bold">Retorno</p>
                    <p className="text-indigo-300 font-bold">R$ 2.100,00</p>
                  </div>
                </div>
        ...
        <div className="w-full py-12">
          ...
          <div className="space-y-4">
            ...
            <div className="p-5 rounded-xl bg-indigo-500/10 border border-indigo-500/20 relative overflow-hidden shadow-sm">
              <div className="absolute -right-6 -top-6 w-24 h-24 bg-indigo-500/20 rounded-full blur-2xl"></div>
              <div className="flex items-start gap-4 z-10 relative">
                <div className="bg-indigo-600 text-white p-2 rounded-full shrink-0 shadow-lg shadow-indigo-500/30">
        ...
        <div className="w-full mt-8 mb-24">
          <div className="w-full text-center space-y-4">
            <div className="inline-block bg-slate-800 rounded-lg px-3 py-1 mb-1">
              ...
              <span className="text-xs font-bold text-indigo-400">Por apenas 12x de R$ 29,90</span>
            </div>
            <button className="w-full bg-indigo-600 hover:bg-indigo-500 active:scale-[0.98] transition-all text-white text-lg font-extrabold py-4 px-6 rounded-xl shadow-[0_8px_30px_-6px_rgba(79,70,229,0.4)] flex items-center justify-center gap-2 group">
      ...
      <nav className="fixed bottom-0 w-full bg-[#0a0a0a] border-t border-slate-800 pb-safe pt-2 z-50">
        <div className="flex justify-around items-end px-2 pb-2">
          <a className="flex flex-col items-center justify-end gap-1 flex-1 min-h-[48px] group" href="#">
            <span className="material-symbols-outlined text-white group-hover:text-indigo-400 transition-colors" style={{ fontSize: '24px', fontVariationSettings: "'FILL' 1" }}>home</span>
            <span className="text-[10px] font-medium text-white group-hover:text-indigo-400 transition-colors">Início</span>
          </a>
          <a className="flex flex-col items-center justify-end gap-1 flex-1 min-h-[48px] group" href="#">
            <span className="material-symbols-outlined text-slate-400 group-hover:text-indigo-400 transition-colors" style={{ fontSize: '24px' }}>search</span>
            <span className="text-[10px] font-medium text-slate-400 group-hover:text-indigo-400 transition-colors">Buscar</span>
          </a>
          <a className="flex flex-col items-center justify-end gap-1 flex-1 min-h-[48px] group" href="#">
            <div className="relative">
              <span className="material-symbols-outlined text-slate-400 group-hover:text-indigo-400 transition-colors" style={{ fontSize: '24px' }}>shopping_bag</span>
              <span className="absolute -top-1 -right-1 flex h-3 w-3 items-center justify-center rounded-full bg-indigo-600 text-[8px] text-white">1</span>
            </div>
            <span className="text-[10px] font-medium text-slate-400 group-hover:text-indigo-400 transition-colors">Carrinho</span>
          </a>
          <a className="flex flex-col items-center justify-end gap-1 flex-1 min-h-[48px] group" href="#">
            <span className="material-symbols-outlined text-slate-400 group-hover:text-indigo-400 transition-colors" style={{ fontSize: '24px' }}>person</span>
            <span className="text-[10px] font-medium text-slate-400 group-hover:text-indigo-400 transition-colors">Perfil</span>
          </a>
        </div>
      </nav>
    </div>
